...
const (
	...
	// When a party finished any phase, broadcast this message to everyone to acknowledge
	TssMessage_ACK_DONE TssMessage_Type = 5
)
...
type AckDoneMessage_ACK_TYPE int32

const (
	AckDoneMessage_KEYGEN  AckDoneMessage_ACK_TYPE = 0
	AckDoneMessage_PRESIGN AckDoneMessage_ACK_TYPE = 1
	AckDoneMessage_SIGNING AckDoneMessage_ACK_TYPE = 2
)

// Enum value maps for AckDoneMessage_ACK_TYPE.
var (
	AckDoneMessage_ACK_TYPE_name = map[int32]string{
		0: "KEYGEN",
		1: "PRESIGN",
		2: "SIGNING",
	}
	AckDoneMessage_ACK_TYPE_value = map[string]int32{
		"KEYGEN":  0,
		"PRESIGN": 1,
		"SIGNING": 2,
	}
...
func (x AckDoneMessage_ACK_TYPE) Enum() *AckDoneMessage_ACK_TYPE {
	p := new(AckDoneMessage_ACK_TYPE)
	*p = x
	return p
}

func (x AckDoneMessage_ACK_TYPE) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AckDoneMessage_ACK_TYPE) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_common_tss_message_proto_enumTypes[2].Descriptor()
}

func (AckDoneMessage_ACK_TYPE) Type() protoreflect.EnumType {
	return &file_proto_common_tss_message_proto_enumTypes[2]
}

func (x AckDoneMessage_ACK_TYPE) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AckDoneMessage_ACK_TYPE.Descriptor instead.
func (AckDoneMessage_ACK_TYPE) EnumDescriptor() ([]byte, []int) {
	return file_proto_common_tss_message_proto_rawDescGZIP(), []int{5, 0}
}
...
type TssMessage struct {
	...
	AckDoneMessage              *AckDoneMessage              `protobuf:"bytes,9,opt,name=ackDoneMessage,proto3" json:"ackDoneMessage,omitempty"`
}
...
func (x *TssMessage) GetAckDoneMessage() *AckDoneMessage {
	if x != nil {
		return x.AckDoneMessage
	}
	return nil
}
...
type AckDoneMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AckType AckDoneMessage_ACK_TYPE `protobuf:"varint,1,opt,name=ackType,proto3,enum=common.AckDoneMessage_ACK_TYPE" json:"ackType,omitempty"`
}

func (x *AckDoneMessage) Reset() {
	*x = AckDoneMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_common_tss_message_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AckDoneMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AckDoneMessage) ProtoMessage() {}

func (x *AckDoneMessage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_common_tss_message_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AckDoneMessage.ProtoReflect.Descriptor instead.
func (*AckDoneMessage) Descriptor() ([]byte, []int) {
	return file_proto_common_tss_message_proto_rawDescGZIP(), []int{5}
}

func (x *AckDoneMessage) GetAckType() AckDoneMessage_ACK_TYPE {
	if x != nil {
		return x.AckType
	}
	return AckDoneMessage_KEYGEN
}
...
var file_proto_common_tss_message_proto_rawDesc = []byte{
	...
	0x12, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22, 0x85, 0x05, 0x0a, 0x0a, 0x54, 0x73, 0x73,
	...
	,
...
var file_proto_common_tss_message_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_proto_common_tss_message_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_common_tss_message_proto_goTypes = []interface{}{
	...
	(AckDoneMessage_ACK_TYPE)(0),            // 2: common.AckDoneMessage.ACK_TYPE
	(*TssMessage)(nil),                      // 3: common.TssMessage
	(*UpdateMessage)(nil),                   // 4: common.UpdateMessage
	(*AvailabilityResponseMessage)(nil),     // 5: common.AvailabilityResponseMessage
	(*PreExecOutputMessage)(nil),            // 6: common.PreExecOutputMessage
	(*AskRequestMessage)(nil),               // 7: common.AskRequestMessage
	(*AckDoneMessage)(nil),                  // 8: common.AckDoneMessage
}
var file_proto_common_tss_message_proto_depIdxs = []int32{
	0, // 0: common.TssMessage.type:type_name -> common.TssMessage.Type
	4, // 1: common.TssMessage.updateMessages:type_name -> common.UpdateMessage
	5, // 2: common.TssMessage.availabilityResponseMessage:type_name -> common.AvailabilityResponseMessage
	6, // 3: common.TssMessage.preExecOutputMessage:type_name -> common.PreExecOutputMessage
	7, // 4: common.TssMessage.askRequestMessage:type_name -> common.AskRequestMessage
	8, // 5: common.TssMessage.ackDoneMessage:type_name -> common.AckDoneMessage
	1, // 6: common.AvailabilityResponseMessage.answer:type_name -> common.AvailabilityResponseMessage.ANSWER
	2, // 7: common.AckDoneMessage.ackType:type_name -> common.AckDoneMessage.ACK_TYPE
...
func file_proto_common_tss_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_common_tss_message_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AckDoneMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
